    ...
    module Concerns
      module Util
        ...
        def time_ago_in_words(time)
          Twitterwatch::Util.time_ago_in_words(time)
        end
        ...
        def parse_time(time)
          Twitterwatch::Util.parse_time(time)
        end
        ...
        def pluralize(count, singular, plural)
          Twitterwatch::Util.pluralize(count, singular, plural)
        end
        ...
        def strip_html(string)
          Twitterwatch::Util.strip_html(string)
        end
        ...
        def strip_control_characters(string)
          Twitterwatch::Util.strip_control_characters(string)
        end
        ...
        def escape_html(string)
          Twitterwatch::Util.escape_html(string)
        end
        ...
        def unescape_html(string)
          Twitterwatch::Util.unescape_html(string)
        end
        ...
        def excerpt(text, max_length, omission = "...")
          Twitterwatch::Util.excerpt(text, max_length, omission)
        end
        ...
        def number_to_human_size(number)
          Twitterwatch::Util.number_to_human_size(number)
        end
        ...
        def suppress_output(&block)
          Twitterwatch::Util.suppress_output(&block)
        end
        ...
        def suppress_warnings(&block)
          Twitterwatch::Util.suppress_warnings(&block)
        end
      end
    end
  end
