module Twitterwatch
    class ConfigurationWizard
      ...
      def gather_configuration
        Twitterwatch::Console.instance.info("Starting configuration wizard.\n")
        configuration = {
          "database_connection_uri" => gather_database_connection_uri,
          "twitter"                 => gather_twitter_keys,
          "klout"                   => gather_klout_keys
        }
        Twitterwatch::Configuration.save!(configuration)
        Twitterwatch::Console.instance.newline
        Twitterwatch::Console.instance.info("Configuration saved to #{Twitterwatch::Configuration::CONFIGURATION_FILE_LOCATION.bold}")
      end
