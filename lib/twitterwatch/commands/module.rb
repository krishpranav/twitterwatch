module Twitterwatch
    module Commands
      class Module < Twitterwatch::Command
        self.meta = {
  ...
  <<-USAGE
  The #{'modules'.bold} command shows information about available Twitterwatch modules.
  ...
  USAGE
        ...
        def show_module(path)
          if !_module = Twitterwatch::Module.module_by_path(path)
        ...
        def show_modules
          ...
          Twitterwatch::Module.descendants.sort_by(&:path).each do |_module|
